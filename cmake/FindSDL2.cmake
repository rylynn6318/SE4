...
if(WIN32)
    ...
    find_path(SDL2_ROOT "include/SDL.h" PATHS "${EXTERN_DIR}/SDL2-${SDL2_VERSION}-dev" NO_DEFAULT_PATH)
    if(SDL2_ROOT)
    ...
    if(NOT SDL2_FOUND)
        ...
        find_path(SDL2_ROOT "include/SDL.h" PATHS "${EXTERN_DIR}/SDL2-${SDL2_VERSION}" NO_DEFAULT_PATH)
        if(SDL2_ROOT)
            set(SDL2_INCLUDE_DIRS "${SDL2_ROOT}/include")
