...
if(NOT SDL2_DIR)
    set(SDL2_DIR "${PROJECT_SOURCE_DIR}/extern/SDL2-2.0.12")
    #message("SDL2_DIR : ${SDL2_DIR} : ${PROJECT_SOURCE_DIR}/extern/SDL2-2.0.12")
endif()
...
# for Windows
set(SDL2_DLL_DIR "${SDL2_DIR}/${VC_LIB_PATH_SUFFIX}")
