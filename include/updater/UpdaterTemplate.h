...
//    }
    ...
    public:
        ...
        explicit UpdaterTemplate(std::function<void(ComponentHandlers ...)> callback);
    ...
    public:
        ...
        explicit UpdaterFunction(std::function<void(int, ComponentHandlers ...)> callback): callback(std::move(callback)) {
